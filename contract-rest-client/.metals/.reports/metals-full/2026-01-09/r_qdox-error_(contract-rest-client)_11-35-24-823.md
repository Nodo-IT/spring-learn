error id: file://<WORKSPACE>/src/main/java/com/nodoit/contract_rest_client/model/Person.java
file://<WORKSPACE>/src/main/java/com/nodoit/contract_rest_client/model/Person.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/nodoit/contract_rest_client/model/Person.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/nodoit/contract_rest_client/model/Person.java